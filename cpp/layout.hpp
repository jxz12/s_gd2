...
void sgd(double* X, vector<term> &terms, const vector<double> &etas, const double delta=0);
...
vector<int> maxmin_random_sp_unweighted(const vector<vector<int>>& graph, int n_pivots, int p0 = 0);
vector<int> maxmin_random_sp_weighted(const vector<vector<edge>>& graph, int n_pivots, int p0 = 0);
