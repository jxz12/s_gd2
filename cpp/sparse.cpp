...
vector<int> maxmin_random_sp_unweighted(const vector<vector<int>>& graph, int n_pivots, int p0)
{
    int n = graph.size();
...
vector<int> maxmin_random_sp_weighted(const vector<vector<edge>>& graph, int n_pivots, int p0)
{
    int n = graph.size();
...
int main()
{
    ...
    //vector<vector<edge>> g = build_graph_weighted(8, 9, I, J, V);
